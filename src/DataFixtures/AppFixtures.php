...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $reservations = [
            ['2025-01-01', '2025-01-02', 'en attente'],
            ['2025-01-03', '2025-01-04', 'en attente'],
            ['2025-01-05', '2025-01-06', 'en attente'],
            ['2025-01-07', '2025-01-08', 'en attente'],
            ['2025-02-01', '2025-02-02', 'confirmée'],
            ['2025-02-03', '2025-02-04', 'confirmée'],
            ['2025-03-01', '2025-03-02', 'annulée'],
            ['2025-03-03', '2025-03-04', 'en attente'],
            ['2025-04-01', '2025-04-02', 'confirmée'],
            ['2025-04-03', '2025-04-04', 'en attente']
        ];
